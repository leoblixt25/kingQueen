...
This tournament is all about good energy, fair play, and enjoying beach volleyball together. Keep it competitive but relaxed, no stress, just great games and positive vibes.
            ...
            <div className="text-sm leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
              {tournamentInfo.split('\n').map((line, index) => {
                if (line.startsWith('**') && line.endsWith('**')) {
                  ...
                  return (
                    <p key={index} className="font-bold my-2 text-base">
                      {content}
                    </p>
                  );
                }
